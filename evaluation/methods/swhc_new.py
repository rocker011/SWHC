...
def _build_query_param() -> QueryParam:
    return QueryParam(
        ...
        swhc_variant="v0",
        swhc_v0_evidence_topk=_parse_int_env("HGRAG_SWHC_V0_EVIDENCE_TOPK", 6),
        swhc_v0_evidence_max_tokens=_parse_int_env(
            "HGRAG_SWHC_V0_EVIDENCE_MAX_TOKENS", 800
        ),
